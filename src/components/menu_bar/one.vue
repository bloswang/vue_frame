<template>
    <div>
      ...
      >
        <el-carousel-item>
          <h3><img src="../../assets/image/bg.jpg" alt=""></h3>
        </el-carousel-item>
        <el-carousel-item>
          <h3><img src="../../assets/image/bj.jpg" alt=""></h3>
        </el-carousel-item>
        <el-carousel-item>
          <h3><img src="../../assets/image/1.jpg" alt=""></h3>
        </el-carousel-item>
        <el-carousel-item>
          <h3><img src="../../assets/image/2.jpg" alt=""></h3>
        </el-carousel-item>
        <el-carousel-item>
          <h3><img src="../../assets/image/3.jpg" alt=""></h3>
        </el-carousel-item>
      </el-carousel>
